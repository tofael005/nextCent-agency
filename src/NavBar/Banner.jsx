...
const Banner = () => {
    return (
        <div className="bg-[#F5F7FA] mb-24 ">
            <div className="flex md:px-28 md:py-20 justify-between flex-col md:flex-row px-6 py-14">
                <div className='mb-12'>
                    <h1 className="md:text-6xl md:mt-14 font-bold mb-5 text-3xl md:text-left text-center md:leading-tight">Lessons and insights <br /> <span className='text-[#4CAF4F]'>from 8 years</span></h1>
