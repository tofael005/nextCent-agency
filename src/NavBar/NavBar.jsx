...
const NavBar = () => {
    ...
    return (
        <div className='bg-[#F5F7FA] md:px-28 py-4'>
            <div className="flex justify-between items-center">
                ...
                <div className={`flex items-center duration-300 flex-col py-5 md:p-0 text-white md:text-gray-900 bg-opacity-90 top-14 bg-black md:bg-transparent w-full text-center md:w-auto md:flex-row gap-6 absolute md:static z-50 ${toggle ? "left-0" : "-left-full"}`}>
                    ...
                    <div className="flex gap-2 items-center font-semibold md:ml-8">
                        <button className='text-[#4CAF4F] px-5 py-2 font-bold duration-500 border-[#4CAF4F] hover:bg-[#4CAF4F] hover:text-white rounded-md'>Login</button>
