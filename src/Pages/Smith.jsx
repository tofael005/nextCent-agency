        ...
        <div className='md:px-28 mb-14 mt-10 bg-[#F5F7FA] px-3 py-16'>
            <div className="grid md:grid-cols-2 items-center">
                ...
                <div className='px-3'>
                    ...
                    <h1 className="my-4 md:text-4xl text-2xl text-[#4CAF4F] font-semibold text-center md:text-left">Tim Smith</h1>
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-6">
                        ...
                        <div className="flex items-center gap-2 text-[#4CAF4F] text-2xl font-semibold md:ml-0 ml-14">
