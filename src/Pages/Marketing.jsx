    ...
    return (
        <div className="md:px-28 mb-28 px-3">
            <div>
                ...
                <p className="text-center my-8">The Nexcent blog is the best place to read about the latest membership insights, <br /> trends and more. See who's joining the community, read about how our community <br /> are increasing their membership income and lot's more.​</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 mt-6 mb-11">
                <div className='relative mb-28'>
                    <img className='w-full' src={imga} alt="" />
                    <div className="bg-slate-100 w-[300px] md:ml-12 ml-8 absolute -mt-20 p-4 mb-28 rounded-md shadow">
