            ...
            <div className="grid md:grid-cols-3 gap-6 mt-6 mb-11">
                <div className='relative mb-28'>
                    ...
                    <div className="bg-slate-100 w-[300px] md:ml-12 ml-8 absolute -mt-20 p-4 mb-28 rounded-md shadow-lg">
                        ...
                        <div className='flex gap-2 items-center justify-center text-[#4CAF4F] text-xl font-semibold md:ml-0 hover:bg-[#4CAF4F] hover:text-white duration-500 px-5 py-2 rounded-md cursor-pointer'>
                            <input className='cursor-pointer' type="button" value="Read more" />
                            <FiArrowRightCircle />
                        </div>
                    </div>
                </div>
